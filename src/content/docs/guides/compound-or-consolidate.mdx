...
Keep in mind that it will take at least **27.3 hours** to complete a consolidation request, plus the queue time.
...
<Checklist name="compound-or-consolidate-via-launchpad-page">
