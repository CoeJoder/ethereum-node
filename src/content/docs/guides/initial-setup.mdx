...
#### On the Client PC:
<Checklist name="download-mint-and-ubuntu-server">
...
#### On the Client PC:
<Checklist name="update-bios-of-the-node-server-1">
...
```
<Checklist name="update-bios-of-the-node-server-2">
...
#### On the Node Server:
<Checklist name="update-bios-of-the-node-server-3">
...
#### On the Node Server:
<Checklist name="install-ubuntu-server-1">
...
```
<Checklist name="install-ubuntu-server-2">
...
#### On the Client PC:
<Checklist name="configure-ssh-1">
...
```
<Checklist name="configure-ssh-2">
...
exit
```
<Checklist name="configure-ssh-3">
...
```
<Checklist name="configure-ssh-4">
...
# coejoder@eth-node-mainnet's password: <password>
```
<Checklist name="configure-ssh-5">
- [ ] create a directory for SSH sockets
</Checklist>
```bash
mkdir -p ~/.ssh/sockets/
```
<Checklist name="configure-ssh-6">
...
```
<Checklist name="configure-ssh-7">
...
```
<Checklist name="configure-ssh-8">
...
```
<Checklist name="configure-ssh-9">
...
```
<Checklist name="configure-ssh-10">
...
#### On the Client PC:
<Checklist name="format-and-mount-secondary-drive-1">
...
<Checklist name="format-and-mount-secondary-drive-2">
...
<Checklist name="format-and-mount-secondary-drive-3">
