...
client_pc_username=${color_green}$client_pc_username${color_reset}
...
node_server_ssh_port=${color_green}$node_server_ssh_port${color_reset}
...
geth_port=${color_green}$geth_port${color_reset}
geth_discovery_port=${color_green}$geth_discovery_port${color_reset}
...
prysm_beacon_p2p_tcp_port=${color_green}$prysm_beacon_p2p_tcp_port${color_reset}
prysm_beacon_p2p_quic_port=${color_green}$prysm_beacon_p2p_quic_port${color_reset}
prysm_beacon_p2p_udp_port=${color_green}$prysm_beacon_p2p_udp_port${color_reset}
